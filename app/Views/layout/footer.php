<!-- <section class="py-10 bg-blue-500 sm:pt-16 lg:pt-24">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-y-12 gap-x-12">
            <div>
                <a href="#" class="flex items-center">
                    ...
                    <span class="self-center text-xl font-semibold whitespace-nowrap text-white">Mari Wisata</span>
                </a>

                <ul class="mt-8 space-y-4">
                    <li>
                        <a href="#" title=""
                            class="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> About
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#" title=""
                            class="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> Works
                        </a>
                    </li>

                    <li>
                        <a href="#" title=""
                            class="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> Career
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="mt-8 space-y-4">
                    ...
                    <li>
                        <a href="#" title=""
                            class="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> Terms &
                            Conditions </a>
                    </li>

                    <li>
                        <a href="#" title=""
                            class="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> Privacy
                            Policy </a>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="mt-8 space-y-4">
                    <li>
                        <a href="#" title=""
                            class="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> Free
                            eBooks </a>
                    </li>
                    ...
                    <li>
                        <a href="#" title=""
                            class="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> How to
                            - Blog </a>
                    </li>

                    <li>
                        <a href="#" title=""
                            class="text-blue-200 transition-all duration-200 hover:text-white focus:text-white"> YouTube
                            Playlist </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="mt-20 md:mt-28 2xl:mt-32">
            <div class="lg:flex lg:items-center lg:justify-between">
                ...
                <p class="mt-6 text-sm text-blue-200 lg:mt-0">&copy; Copyright <?= Date('Y'); ?>, All Rights Reserved
                    by Mari Wisata</p>
            </div>
        </div>
    </div>
...
<section class="py-10 bg-primary sm:pt-16 lg:pt-24">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-6 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <a href="#" class="flex items-center">
                    <img src="assets/img/logo-mariwisata.png" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
                    <span class="self-center text-xl font-semibold whitespace-nowrap text-white">Mari Wisata</span>
                </a>
                <p class="text-base leading-relaxed text-white mt-7">Mari Wisata merupakan Web Apss yang menyediakan destinasi wisata yang menarik di daerah Jawa Barat.</p>
                ...
                <ul class="flex items-center space-x-3 mt-9">
                    ...
                    <!-- github -->
                    <li>
                        <a href="https://github.com/rifqmd/mari-wisata" target="_blank" title="" class="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-300 focus:bg-blue-300">
                            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                <path
                                    fill-rule="evenodd"
                                    clip-rule="evenodd"
