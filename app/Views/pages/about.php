...
<section class="pt-10 overflow-hidden bg-gray-50 md:pt-0 sm:pt-16 2xl:pt-16">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid items-center grid-cols-1 md:grid-cols-2">
            <div>
                <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Hello 👋, We <br class="block sm:hidden" />Mari Wisata</h2>
                ...
                <p class="mt-4 text-xl text-gray-600 md:mt-8">
                    ...
                    <br class="block sm:hidden" />Kirim pesan anda <a href="#" title="" data-modal-toggle="kirimPesan" class="transition-all duration-200 text-sky-500 hover:text-sky-600 hover:underline">disini</a>
                </p>

                <!-- Main modal Start -->
                <div id="kirimPesan" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                    <div class="relative w-full h-full max-w-2xl md:h-auto">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                                ...
                                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="kirimPesan">
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                                            <div>
                                                ...
                                                <div class="mt-2.5 relative">
                                                    <input type="text" name="" id="" placeholder="Masukan nama.." class="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600" />
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-2.5 relative">
                                                    <input type="email" name="" id="" placeholder="Masukan email.." class="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600" />
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-2.5 relative">
                                                    <input type="tel" name="" id="" placeholder="Masukan nomer telfon.." class="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600" />
                                                </div>
                                            </div>
            ...
            <div class="relative">
                ...
                <img class="relative w-full xl:max-w-lg xl:mx-auto 2xl:origin-bottom 2xl:scale-110" src="assets/img/team.png" alt="" />
            </div>
        </div>
    </div>
</section>
    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid items-center grid-cols-1 gap-y-12 lg:grid-cols-2 lg:gap-x-24">
            ...
            <div class="text-left">
                ...
                <a href="#" title="" class="inline-flex items-start justify-start px-8 py-4 font-semibold text-white transition-all duration-200 bg-blue-600 rounded-md mt-9 hover:bg-blue-700 focus:bg-blue-700" role="button">Selengkapnya</a>
            </div>
        </div>
    </div>
</section>
...
<section class="py-5 mb-16 bg-white sm:py-16 lg:py-24">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div class="flex flex-col items-center justify-center mt-8 space-y-4 md:space-y-0 md:space-x-4 md:flex-row lg:mt-12">
            <a href="https://www.apple.com/id/ios/ios-16/" target="_blank" title="ios" class="inline-flex items-center justify-center px-4 py-4 text-black transition-all duration-200 border-2 border-black rounded-md hover:bg-black hover:text-white focus:bg-black focus:text-white" role="button">
            ...
            <a href="https://www.android.com/intl/id_id/" target="_blank" title="android" class="inline-flex items-center justify-center px-4 py-4 text-black transition-all duration-200 border-2 border-black rounded-md hover:bg-black hover:text-white focus:bg-black focus:text-white" role="button">
    ...
    <div class="container">
        <div class="w-full px-4">
            <div class="mx-auto text-center mb-16">
                ...
                <p class="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-600">Kami pernah bekerja sama dalam membangun project-project berbasis website</p>
            </div>
        </div>
        <div class="w-full px-4">
        ...
        <div class="py-10 sm:py-16 lg:py-24 2xl:pl-24">
            <div class="grid items-center grid-cols-1 gap-y-8 lg:grid-cols-2 lg:gap-x-8 2xl:gap-x-20">
                ...
                <div class="lg:order-1 ml-5 ">
                    ...
                    <ul class="grid-flow-col gap-2 mt-4 sm:mt-10 sm:grid-cols-2 gap-x-10 xl:gap-x-16 gap-y-4 xl:gap-y-6">
                    ...
                    <div class="flex flex-col items-start mt-8 sm:space-x-4 sm:flex-row sm:items-center lg:mt-12">
                        ...
                        <a href="#" title="" class="inline-flex items-center justify-center px-4 py-4 text-base font-semibold text-white transition-all duration-200 bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:bg-blue-700" role="button">
                            <svg class="w-6 h-6p mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
